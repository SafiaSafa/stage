PC_0=read.table("file:///home/vcabeli/stage/curve_analysis/result/0/resultat//prs_low_ld_5.res",sep=",")
PC_1=read.table("file:///home/vcabeli/stage/curve_analysis/result/1/resultat//prs_low_ld_5.res",sep=",")
PC_2=read.table("file:///home/vcabeli/stage/curve_analysis/result/2/resultat//prs_low_ld_5.res",sep=",")
PC_5=read.table("file:///home/vcabeli/stage/curve_analysis/result/5/resultat//prs_low_ld_5.res",sep=",")
...
plot(seq(1, length(PC_0)*500, by=500),lapply(PC_0,mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par P-value)")
...
plot(c(1,500, 1000),lapply(PC_0[1:3],mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par P-value)\n zoom sur les 1000 premiers SNPs")
