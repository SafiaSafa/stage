PC_0=read.table("file:///home/vcabeli/stage/curve_analysis/ldscore/result/0_ldscore/resultat/prs_low_ld_5.res",sep=",")
PC_1=read.table("file:///home/vcabeli/stage/curve_analysis/ldscore/result/1_ldscore/resultat/prs_low_ld_5.res",sep=",")
PC_2=read.table("file:///home/vcabeli/stage/curve_analysis/ldscore/result/2_ldscore/resultat/prs_low_ld_5.res",sep=",")
PC_5=read.table("file:///home/vcabeli/stage/curve_analysis/ldscore/result/5_ldscore/resultat/prs_low_ld_5.res",sep=",")
...
plot(seq(1, length(PC_0)*500, by=500),lapply(PC_0,mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par ldscore)")
...
plot(c(1,500, 1000),lapply(PC_0[1:3],mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par ldscore)\n zoom sur les 1000 premiers SNPs")
