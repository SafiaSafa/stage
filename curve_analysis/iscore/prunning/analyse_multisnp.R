PC_0=read.table("file:///home/vcabeli/stage/curve_analysis/iscore/prunning/0_iscore/resultat/prs_low_ld_5.res",sep=",")
PC_1=read.table("file:///home/vcabeli/stage/curve_analysis/iscore/prunning/1_iscore/resultat/prs_low_ld_5.res",sep=",")
PC_2=read.table("file:///home/vcabeli/stage/curve_analysis/iscore/prunning/2_iscore/resultat/prs_low_ld_5.res",sep=",")
PC_5=read.table("file:///home/vcabeli/stage/curve_analysis/iscore/prunning/5_iscore/resultat/prs_low_ld_5.res",sep=",")
...
plot(seq(1, length(PC_0)*500, by=500),lapply(PC_0,mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par iscore_pr)")
...
plot(c(1,500, 1000),lapply(PC_0[1:3],mean),type="l",xlab="# SNPs",ylab="AUC", main="AUC en fonction du # SNPs (SNPs classé par iscore_pr)\n zoom sur les 1000 premiers SNPs")
