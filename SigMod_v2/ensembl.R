...
bed <- as.data.frame(read.table("~/stage/SigMod_v2/BP.B37-final.map",header = FALSE, sep="\t",stringsAsFactors=FALSE))
...
write.table(out,"~/stage/SigMod_v2/gene_snp.txt",row.names=FALSE, quote = F)
