...
# get snp location
#plink --bfile /home/vcabeli/Documents/analyses_current/GRIV_DESIR/GRIV_DESIR_PR --recode --out GRIV_DESIR_PR

bed <- as.data.frame(read.table("~/stage/GRIV/GRIV_DESIR_PR.map",header = FALSE, sep="\t",stringsAsFactors=FALSE))
...
write.table(out,"~/stage/GRIV/gene_snp.txt",row.names=FALSE, quote = F)
